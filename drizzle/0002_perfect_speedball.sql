...
INSERT INTO `__new_orders`("id", "tableId", "menuId", "quantity", "isCompleted", "createdAt", "updatedAt") SELECT "id", "tableId", "menuId", "quantity", "isCompleted", "createdAt", "updatedAt" FROM `orders`;--> statement-breakpoint
